    ...
    <body>
        ...
        <main class="mb-4">
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <p>Lütfen formu doldurunuz, sizinle en kısa sürede iletişime geçeceğiz!</p>
                        <div class="my-5">
                            <!-- * * * * * * * * * * * * * * *-->
                            ...
                            <form method="POST" action="iletisim.php#bildiri" data-sb-form-api-token="API_TOKEN">
                                ...
                                <div class="form-floating">
                                    <input class="form-control" name="email" type="email" placeholder="E-mail Adres" data-sb-validations="required,email" />
                                    <label for="email">E-mail Adres</label>
                                    <div class="invalid-feedback" data-sb-feedback="email:required">E-mail Adresinizi Giriniz!</div>
                                    <div class="invalid-feedback" data-sb-feedback="email:email">Email is not valid.</div>
                                </div>
                                <div class="form-floating">
                                    <input class="form-control" name="phone" type="tel" placeholder="Telefon" data-sb-validations="required" />
                                    <label for="phone">Telefon</label>
                                    <div class="invalid-feedback" data-sb-feedback="phone:required">Telefon Numaranızı Giriniz!</div>
                                </div>
                                <div class="form-floating">
                                    <textarea class="form-control" name="message" placeholder="Mesaj" style="height: 12rem" data-sb-validations="required"></textarea>
                                ...
                                <!-- Submit Button-->
                                <input type="submit" name="submit" class="btn btn-primary text-uppercase " value="Gönder">
                                <div id="bildiri"></div>
                                <?php
                                if(@$_GET["i"] == "ok"){
